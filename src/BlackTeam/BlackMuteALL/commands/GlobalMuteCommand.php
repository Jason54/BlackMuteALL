...
namespace BlackTeam\BlackMuteALL\commands;
...
use BlackTeam\BlackMuteALL\Loader;
class GlobalMuteCommand extends PluginCommand implements Listener {
    ...
    public function execute(CommandSender $sender, string $commandLabel, array $args) {
    	if($sender->hasPermission("global.mute")){
         ...
         $sender->sendMessage(TF::RED . "Vous n'êtes pas autorisé à utiliser cette commande.");
     }
